...
class Demo(ezui.WindowController):
    ...
    def build(self):
        ...
        * TwoColumnForm         @form
        ...
        for identifier in ["sourceFont", "targetFont"]:
            # Get the UI element
            ...
            if identifier == "targetFont" and len(self.fonts) > 1:
                drop_down.set(1)
    ...
    def buttonCallback(self, sender):
        ...
        min_font = self.fonts[self.w.getItem("sourceFont").get()]
        # Get the font from the second dropdown
        max_font = self.fonts[self.w.getItem("targetFont").get()]
